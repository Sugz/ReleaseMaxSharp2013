    ...
    public class Node : ReferenceTarget
    {
        ...
        public class NodeUserData
        {
            ...
            public string this[string key]
            {
                get
                {
                    if (node.UserPropExists(ref key))
                    {
                        string ret = "";
                        node.GetUserPropString(ref key, ref ret);
                        return ret;
                    }
                    else
                    {
                ...
                {
                    string tmp = value;
                    node.SetUserPropString(ref key, ref value);
                }
            }
        }
        ...
        public class NodeVisibility
        {
            ...
            public bool Primary
            {
                get
                {
                    return node.PrimaryVisibility != 0;
                }
                set
                {
                    node.SetPrimaryVisibility(value);
                }
            }
            ...
            public bool Secondary
            {
                get
                {
                    return node.SecondaryVisibility != 0;
                }
                set
                {
                    node.SetSecondaryVisibility(value);
                }
            }
        }
        ...
        public String UserPropertyBuffer
        {
            ...
            set { string tmp = value; _Node.SetUserPropBuffer(ref tmp); }
        }
